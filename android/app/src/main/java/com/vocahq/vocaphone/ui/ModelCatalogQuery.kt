 ...
 *
 * Per model rather than per sherpa family: the family is an engine detail, and
 * reading copy off it told Russian speakers that GigaAM -- a Russian-only
 * transducer -- was "the fastest multilingual model", and said the same of the
 * English-only Parakeet. See [ModelPlainLanguage].
 */
fun LocalModelDescriptor.recommendationWhy(): String = plain.summary
