...
class AboutCopyTest {
    ...
    fun `family and contact links match the public sites`() {
        ...
        assertEquals("https://discord.gg/t6muquAJbm", DISCORD_URL)
    ...
    fun `talk-to-us hrefs match the VocaDesign social README`() {
        ...
        assertTrue(readme.contains("https://discord.gg/t6muquAJbm"))
    ...
    fun `about copy names the family and stays honest about status`() {
        ...
        assertTrue(ABOUT_STATUS.contains("Google Play"))
        assertTrue(ABOUT_STATUS.contains("Android 13"))
        assertFalse(ABOUT_STATUS.contains("Public beta", ignoreCase = true))
        ...
        assertTrue(ABOUT_FAMILY_NOTE.contains("VocaLinux and VocaMac are available now"))
        ...
        assertFalse(ABOUT_FAMILY_NOTE.contains("Developer beta"))
